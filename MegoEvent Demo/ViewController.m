...
#import "saveImage.h"
#import <MegoAction/MAActionPerformer.h>
...
@interface ViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    ...
    saveImage *saveimage;
    NSInteger itemTag;
    MAActionPerformer *mAActionPerformer;
...
-(void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receiveNotification)
                                                 name:@"GoogleResponse" object:nil];
...
-(void)headerSection
{
    ...
    groupLabel.text = @"Mego Event Demo";
...
-(void)galleryImageViewClick
{
    ...
    if (!mAActionPerformer) {
        mAActionPerformer=[MAActionPerformer sharedActionManager];
    }
    NSMutableDictionary *dictionary =[[NSMutableDictionary alloc] init];
    [mAActionPerformer onActionPerformed:@"UQZ1U5B4K" status:@"Complete" Dictionary:dictionary];
...
-(void)PushToViewController:(long)indexPath
{
    switch(indexPath)
    {
        case 0:
        {
            ...
            NSMutableDictionary *dictionary =[[NSMutableDictionary alloc] init];
            [mAActionPerformer onActionPerformed:@"1GWTOF8M4" status:@"Complete" Dictionary:dictionary];
        }
            break; 
        case 1:
            //    [meuserObj postUserData :@"0"]; //PrefBackup
            break;
        case 2:
            //       [meuserObj getUserData :@"0"];  //PrefStore
            break;
        case 3:
        {
