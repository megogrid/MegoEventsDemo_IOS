...
-(void)loadMainView
{
    ...
    [fb setBackgroundImage:[UIImage imageNamed:@"facebook.png"] forState:normal];
    fb.tag=10;
    ...
    [google setBackgroundImage:[UIImage imageNamed:@"google+.png"] forState:normal];
    google.tag=11;
    ...
    [email setBackgroundImage:[UIImage imageNamed:@"emailApp.png"] forState:normal];
    email.tag=12;
    ...
    [phoneNo setBackgroundImage:[UIImage imageNamed:@"phone_No.png"] forState:normal];
    phoneNo.tag=13;
...
-(void)resetConfigurationClick:(id)sender
{
    ...
    {
        [appSecretData addObject:@"T274TVIZE"];
        [appSecretData addObject:@"QUO0D5D3N"];
    }
    else if(getTag==13)
    {
